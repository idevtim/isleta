...
// ISLETA FORK. See the header: these two are the names that are actually posted.
NSString *kMRNowPlayingPlaybackQueueChangedNotification = @"kMRNowPlayingPlaybackQueueChangedNotification";
NSString *kMRPlayerPlaybackQueueChangedNotification = @"kMRPlayerPlaybackQueueChangedNotification";
...
// ISLETA FORK. See the header for why both are needed and why the plural spelling is not.
NSString *kMRMediaRemoteOptionPlaybackQueueOffset = @"kMRMediaRemoteOptionPlaybackQueueOffset";
NSString *kMRMediaRemoteOptionContentItemID = @"kMRMediaRemoteOptionContentItemID";
...
// ISLETA FORK.
CFStringRef MRMediaRemoteRequestNowPlayingPlaybackQueueSync = CFSTR("MRMediaRemoteRequestNowPlayingPlaybackQueueSync");
...
@synthesize requestNowPlayingPlaybackQueue;
-(id)init
{
    if (!(self = [super init])) {
        return nil;
    ...
    // ISLETA FORK. Deliberately not fatal when absent: everything else here keeps working on an OS
    // that has withdrawn this symbol, and a nil check at the two call sites costs less than a
    // launch that fails outright for a sneak peek.
    requestNowPlayingPlaybackQueue = (MRMediaRemoteRequestNowPlayingPlaybackQueueSync_t)CFBundleGetFunctionPointerForName(bundle, MRMediaRemoteRequestNowPlayingPlaybackQueueSync);
    return self;
}
@end
