...
/// only exist as literals at `settingsText` call sites — there is no registry to enumerate — so the
...
@Suite struct LocalizationCoverageTests {
    ...
    static let lookupFunction = "settingsText"
    ...
    static let definitionFileName = "SettingsText.swift"
    ...
    static var moduleDirectory: URL {
        URL(fileURLWithPath: #filePath)
            ...
            .appendingPathComponent("Sources/IslandSettings")
    }
