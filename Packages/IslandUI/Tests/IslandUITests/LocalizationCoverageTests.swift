...
/// only exist as literals at `islandText` call sites — there is no registry to enumerate — so the
...
@Suite struct LocalizationCoverageTests {
    ...
    static let lookupFunction = "islandText"
    ...
    static let definitionFileName = "IslandText.swift"

    static var moduleDirectory: URL {
        URL(fileURLWithPath: #filePath)
            .deletingLastPathComponent()   // IslandUITests
            .deletingLastPathComponent()   // Tests
            .deletingLastPathComponent()   // package root
            .appendingPathComponent("Sources/IslandUI")
    }
